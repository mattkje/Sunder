# Vendored from https://github.com/ZFTurbo/Music-Source-Separation-Training
# (models/bs_roformer/mel_band_roformer.py) — reconstructs the
# becruily/mel-band-roformer-deux architecture so its checkpoint can be
# loaded and converted to CoreML. Unmodified except this header comment.
