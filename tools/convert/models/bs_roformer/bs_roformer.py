...
# (models/bs_roformer/bs_roformer.py) -- plain BS-Roformer (fixed
# contiguous frequency bands, no mel filterbank, no HyperACE-style CNN
# head) used by e.g. unwa's "Resurrection" checkpoints. Unmodified except
# this header comment.
